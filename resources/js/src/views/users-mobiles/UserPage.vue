<template>
  <div id="users-page">
    <v-card>
      <v-card-title>Usuarios Moviles</v-card-title>
        ...
        <template v-slot:item.name="{ item }">
          <div class="d-flex align-center">
            ...
            <div class="d-flex flex-column">
              <router-link :to="{ name: 'admin-mobiles-view', params: { id: item.id } }" class="text--primary font-weight-semibold text-truncate cursor-pointer text-decoration-none">{{ item.name }}</router-link>
