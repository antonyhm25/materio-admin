...
export default {
  ...
  data: () => ({
    ...
    permissions: [
      ...
      { module: 'Cuenta', title: 'Ver Cuenta', roles: ['superadmin'] },
      { module: 'Cuenta', title: 'Actualizar Cuenta', roles: ['superadmin'] },
      ...
      { module: 'Comidas', title: 'Ver Lista de Comidas', roles: ['superadmin'] },
      { module: 'Comidas', title: 'Crear y Actualizar Comidas', roles: [] },
      { module: 'Comidas', title: 'Eliminar Comidas',  roles: [] },
      { module: 'Ofertas de Comidas', title: 'Ver Lista de Ofertas de Comidas', roles: ['superadmin'] },
      { module: 'Ofertas de Comidas', title: 'Crear y Actualizar Ofertas de Comidas', roles: [] },
      { module: 'Ofertas de Comidas', title: 'Eliminar Ofertas de Comidas', roles: [] },
    ],
